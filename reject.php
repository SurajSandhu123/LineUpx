...
<body onload="maincontent()">
  ...
  <a href="#"><i class="fa fa-window-close fa-2x"></i> Rejected Job</a>
  <hr>
   <p>Support</p>
...
$i=1;
$sql = "SELECT Id,Jobtitle,Company,Location,Applied,Experiance,Candidate,Packege,Hours FROM reject";
...
"<div class=\"block1\" style=\"display:inline-block;\">
    ...
    <b>".$row["Jobtitle"]."</b><br>
      ...
      <b id=\"bold\" >".$row["Packege"]."<br><br><center style=\"color:red;\">Rejected</center></b><br>
