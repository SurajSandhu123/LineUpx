...
<body onload="maincontent()" ng-app="app">
  ...
  <a href="#" style="margin-left: 2px"> <i class="fa fa-user fa-2x "></i><b> Candidate</b></a>
  <hr>
  <p>Jobs</p>
...
"<div class=\"block1\" style=\"display:inline-block;\">
    ...
    <b>".$row["Jobtitle"]."</b><br>
      ...
      <b id=\"bold\" >".$row["Packege"]."<br><br><button style=\"width:50%; height:12%; background-color: white;margin-left:15px;\">Add Candidate</button></b><br>
